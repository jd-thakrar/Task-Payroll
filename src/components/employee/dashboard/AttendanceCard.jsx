      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 relative z-10">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h4 className="text-xl font-bold text-slate-900 leading-none">Currently Punched Out</h4>
            </div>
          </div>
          
          <div className="flex items-center gap-8 pl-1">
             <div className="space-y-1">
                <p className="text-[9px] font-bold text-slate-300 uppercase tracking-widest">Entry Time</p>
                <p className="text-sm font-bold text-slate-600">--:--</p>
             </div>
             <div className="w-px h-8 bg-slate-100" />
             <div className="space-y-1">
                <p className="text-[9px] font-bold text-slate-300 uppercase tracking-widest">Shift Total</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="w-14 h-14 flex items-center justify-center text-slate-400 hover:text-amber-500 bg-slate-50 hover:bg-amber-50 border border-slate-100 rounded-[20px] transition-all group/coffee">
             <Coffee size={20} className="group-hover/coffee:scale-110 transition-transform" />
          </button>
        </div>
      </div>
